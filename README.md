...
In this tutorial we'll setup a [Computor](https://www.computors.org/computing/qomputor "Qomputor") Node (Mining node needs slightly different approach and will be covered later), we try to make this tutorial as easy as possible but some knowledge of computer systems is definitely required. This tutorial is a community initiative. For more information or questions join [Syzygy Discord ](https://discord.gg/2vDMR8m "Syzygy Discord").
